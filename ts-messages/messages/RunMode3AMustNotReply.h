#ifndef __RunMode3AMustNotReply_h
#define __RunMode3AMustNotReply_h
...
class CRunMode3AMustNotReply:public TServerMessage
{
...
public:
    ...
    CRunMode3AMustNotReply(void)
    {
        setCmdID(mCmdID);
    }
    CRunMode3AMustNotReply(Json::Value obj):TServerMessage(obj)
    {
        set(obj);
        setCmdID(mCmdID);
    }
