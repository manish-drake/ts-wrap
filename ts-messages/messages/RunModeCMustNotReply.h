#ifndef __RunModeCMustNotReply_h
#define __RunModeCMustNotReply_h
...
class CRunModeCMustNotReply:public TServerMessage
{
...
public:
    ...
    CRunModeCMustNotReply(void)
    {
        setCmdID(mCmdID);
    }
    CRunModeCMustNotReply(Json::Value obj):TServerMessage(obj)
    {
        set(obj);
        setCmdID(mCmdID);
    }
